/* 
THIS FILE CALLED DUMMY.JS IS NOT TO BE USED. 
    ...
    <!-- This is the div for the cards -->
        <div class="card float-center" style="width: 18rem;">
            <div class="card-body bg-primary text-white">
              <h5 class="card-title">${employeesArr[i].name}</h5>
              <p class="card-text">${employeesArr[i].role}</p>
            </div>
            <ul class="list-group list-group-flush">
              <li class="list-group-item">${employeesArr[i].id}</li>
              <li class="list-group-item">${employeesArr[i].email}</li>
              <li class="list-group-item">${employeesArr[i].officeNum}</li>
            </ul>
        </div>
    `
    console.log("THis is my manager name:", employeesArr.name)
}
